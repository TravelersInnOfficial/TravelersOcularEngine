 ifeq ($(OS),Windows_NT)
    ...
    LIBS 				:= -lopengl32 -lm -lsfml-window -lsfml-graphics -lsfml-system -lglew32 -lassimp -lsoil2
else
    Target				:= EngineTest
    ...
    LIBS 				:= -lGL -lsfml-window -lsfml-graphics -lsfml-system -lGLEW -lassimp -lsoil2
endif
